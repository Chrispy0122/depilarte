...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderRetentionTable(clients, weekStartStr) {
        ...
        clients.forEach(client => {
            ...
            const mensajeRecordatorio = `¡Hola! Nos comunicamos de *SPA*. Queríamos recordarte que es tiempo de tu próxima sesión para continuar con tus excelentes resultados. ¿Deseas agendar?`;
                ...
                <td data-label="Teléfono" style="padding:12px; color:#000000;">
                    <div style="display:flex; flex-direction:column; gap:4px;">
                        ...
                        <div style="display: flex; gap: 5px; margin-top: 5px; flex-wrap: wrap;">
                            ...
                            <a href="https://wa.me/${waNum}?text=${encodeURIComponent(mensajeRecordatorio)}" target="_blank" class="btn-whatsapp" 
